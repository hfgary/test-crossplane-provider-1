# ====================================================================================
# Setup Project
PROJECT_NAME := provider-myprovidera
...
XPKGS = provider-myprovidera
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-myprovidera: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider MyProviderA CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider MyProviderA controllers
...
# This target prepares repo for your provider by replacing all "myprovidera"
